...
{
	ext4k_debug("ext4_ext_index_trans_blocks called");
...
ext4_access_path(handle_t *handle, struct inode *inode,
		struct ext4_ext_path *path)
{
	ext4k_debug("ext4_access_path called");
	int credits, err;
...
{
	ext4k_debug("ext4_collapse_range called");
	struct super_block *sb = inode->i_sb;
...
{
	ext4k_debug("ext4_insert_range called");
	struct super_block *sb = inode->i_sb;
	handle_t *handle;
	struct ext4_ext_path *path;
	struct ext4_extent *extent;
