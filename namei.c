...
static int ext4_create(struct inode *dir, struct dentry *dentry, umode_t mode,
		       bool excl)
{
	ext4k_debug("ext4_create called");
	//ext4k_debug("dir->i_ino : %lu, dentry->d_inode->i_ino : %lu, mode : %hd", dir->i_ino, dentry->d_inode->i_ino, mode);
	ext4k_debug("dir->i_ino : %lu\ndentry->iname : %s\nmode : %hd", dir->i_ino, dentry->d_name.name, mode);
	handle_t *handle;
	struct inode *inode;
...
{
	ext4k_debug("ext4_tmpfile called");
...
{
	ext4k_debug("ext4_symlink called");
...
{
	ext4k_debug("ext4_whiteout_for_rename called");
